...
import com.jidian.base.annotation.FieldFilter;
import com.jidian.base.annotation.FieldFilters;
import com.jidian.base.annotation.NoReflection;
...
public class MyResponseBodyAdvice implements ResponseBodyAdvice {
	 ...
	 * @return
	 */
	private Map<String, Object> processSingleObject(Object obj, FieldFilter fieldFilter) throws IllegalAccessException {
		Map<String, Object> returnMap = new HashMap<>();
		// 获取过滤的属性
		if (fieldFilter != null) {
			...
			if (fieldValue != null) {
				...
				// 属性为map
					...
					if (hasFieldFilter != null) {
						Map<String, Object> fieldValueMap = this.processSingleObject(fieldValue, hasFieldFilter);
						returnMap.put(field.getName(), fieldValueMap);
					} else {
						// 属性过滤
